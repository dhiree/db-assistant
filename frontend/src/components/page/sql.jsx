      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <div className="flex flex-col sm:flex-row gap-4">
            <Input
              type="text"
              placeholder="Enter your SQL host"
            ...
            <Input
              type="text"
              placeholder="Enter your SQL port"
            ...
            <Input
              type="text"
              placeholder="Enter your SQL username"
            ...
            <Input
              type="password"
              placeholder="Enter your SQL password"
            ...
            <Button
              onClick={connectToDB}
              disabled={isConnected || isConnecting || !sqlConnection.host}
      ...
      {isConnected && (
        <Card className="mb-8">
          ...
          <CardFooter>
            <Button
              onClick={sendQuery}
              disabled={isQuerying || !prompt || !tableName}
                ...
                <div className="bg-slate-900 text-slate-50 rounded-md p-4 overflow-auto shadow-inner">
                  {sqlQuery ? (
                    <div className="font-mono text-sm">
                      <div className="text-blue-300 mb-2">// Generated SQL Query</div>
